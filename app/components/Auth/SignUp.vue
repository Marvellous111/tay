...
import { signUp, useSession } from '../../../server/lib/auth-client';
  ...
  <div class="auth-form">
    ...
    <section class="form">
      <div class="input-form">
        <label class="geist-medium">email</label>
        <input type="email" class="geist-regular input" placeholder="Email" v-model="email" />
      </div>
      <div class="input-form">
      ...
      <div class="input-form">
        <label class="geist-medium">name</label>
        <input type="text" class="geist-regular input" placeholder="Name" v-model="name" />
      </div>
      <div class="input-form">
    ...
    <section class="bottom">
      <span class="geist-regular ac-wrapper">
        ...
        <button class="ac geist-medium" @click="changeAuth('SIGNIN')">Signin</button> 
      </span>
      <div class="button-wrapper">
        <button class="auth-button" @click="authSignUp">
          <span class="geist-medium" v-if="isLoading == false">Create an account to use tay</span>
